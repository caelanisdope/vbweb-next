...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="gradient-volleyball py-16 relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="container-apple relative z-10">
          ...
          >
            ...
            >
              <span className="text-sm font-semibold">2025-2026 赛季</span>
            ...
            <motion.p
              className="text-xl md:text-2xl opacity-95 mb-8 font-medium"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-white/80 text-sm">基于赛季表现的深度分析</p>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {insights.map((insight, index) => (
                  <motion.div
                    key={index}
                    className="bg-white/15 backdrop-blur-md rounded-xl p-5 border border-white/20 hover:bg-white/20 transition-all"
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <p className="text-white/95 font-medium leading-relaxed">{insight.text}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
        ...
        >
          <div className="flex items-end justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600 text-sm">完整比赛统计 · 个人技术数据</p>
            </div>
            <Badge variant="primary" size="lg" className="px-4">
          ...
          {filteredMatches.length === 0 ? (
            <div className="text-center py-20">
              <p className="text-xl text-gray-500">暂无比赛数据</p>
            </div>
          ) : (
